...
func _init(p_id: String = "", p_name: String = "", p_desc: String = "", p_icon: Texture2D = null, 
		p_stackable: bool = false, p_max_stack: int = 1, p_scene: PackedScene = null) -> void:
...
func duplicate_item() -> Item:
	...
	var new_item = Item.new(id, item_name, description, icon, stackable, max_stack_size, item_scene)
